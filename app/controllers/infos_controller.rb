      ...
      file_value = 0 #set pra retomar o calculo da receita das venda
        ...
        redirect_to infos_url, notice:"Conteúdo inválido!"
          ...
          file_info.split("\n").each_with_index do |line, index|
            line = line.split("\t")
            next unless index > 0
            @sale = Sale.new #como chamar outra classe? ou essa bloco tinha que estar em sales_controller?
            @sale.buyer = line [0],
            ...
            file_value += line[2].to_f * line[3].to_i  #calculando mas não está criando 'sales' T_T
            @sale.save
          end
        file_value
